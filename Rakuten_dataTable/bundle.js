...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _add_modal = __webpack_require__(65);

	var _add_modal2 = _interopRequireDefault(_add_modal);

	var _delete_modal = __webpack_require__(66);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DataTable = function (_Component) {
		...
		function DataTable(props) {
			...
			_this.showEditModal = _this.showEditModal.bind(_this);
		...
		_createClass(DataTable, [{
			key: 'showDeleteModal',
			value: function showDeleteModal(item, e) {
			...
			key: 'showEditModal',
			value: function showEditModal(item) {
				$('#edit-modal').modal('show');
				this.setState(_extends({}, item, { error: { name: '', phone: '', email: '' } }));
				this.props.selectItem(item);
			}
		}, {
			key: 'onInputChange',
			value: function onInputChange(key, e) {
			...
			value: function onEditClick() {
				...
				if (this.validate()) {
					this.props.editItem({ name: name, phone: phone, email: email }, this.props.item.name);
					...
					return _react2.default.createElement(
						...
						{ key: index, className: 'item myRow',
							onClick: function onClick() {
								return _this3.showEditModal(item);
							}
						},
						_react2.default.createElement(
							'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('img', { src: './img/delete.png', title: '\u522A\u9664\u6B64\u5217', alt: 'delete',
								onClick: function onClick(e) {
									return _this3.showDeleteModal(item, e);
								}
							})
						)
					);
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ selectItem: _index.selectItem, editItem: _index.editItem }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddModal = function (_Component) {
		...
		_createClass(AddModal, [{
			...
			value: function onAddClick() {
				...
				if (this.validate()) {
					this.props.addItem({ name: name, phone: phone, email: email });
					this.setState({
						name: '',
						phone: '',
						email: '',
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ addItem: _index.addItem }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ deleteItem: _index.deleteItem }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_data = __webpack_require__(68);

	var _reducer_data2 = _interopRequireDefault(_reducer_data);

	var _reducer_selectedItem = __webpack_require__(69);
