...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var ba=__webpack_require__(6),ea=__webpack_require__(2),m=__webpack_require__(15),A=__webpack_require__(5),C=__webpack_require__(8),fa=__webpack_require__(16),ha=__webpack_require__(17),ja=__webpack_require__(18),ka=__webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mapDispatchToProps = __webpack_require__(39);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _data_table = __webpack_require__(61);

	var _data_table2 = _interopRequireDefault(_data_table);

	var _add_modal = __webpack_require__(66);

	var _add_modal2 = _interopRequireDefault(_add_modal);

	var _delete_modal = __webpack_require__(67);

	var _delete_modal2 = _interopRequireDefault(_delete_modal);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_add_modal2.default, null),
	        _react2.default.createElement(_data_table2.default, null),
	        _react2.default.createElement(_delete_modal2.default, null)
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _data_List = __webpack_require__(63);

	var _data_List2 = _interopRequireDefault(_data_List);
	...
	var DataTable = function (_Component) {
		...
		function DataTable() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataTable.__proto__ || Object.getPrototypeOf(DataTable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				...
				_this.setState(_extends({}, item, { error: { name: '', phone: '', email: '' } }));
				_this.props.selectItem(item);
			}, _this.onInputChange = function (key, e) {
				...
				if (_this.validate()) {
					_this.props.editItem({ name: name, phone: phone, email: email }, _this.props.item.name);
		...
		_createClass(DataTable, [{
			...
			value: function validate() {
				...
				var input = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'all';

				var noError = true;
				var error = _extends({}, this.state.error);
				...
				if (input === 'name' || input === 'all') {
					if (!this.state.name) {
						...
						var duplicate = this.props.data.some(function (item) {
							return item.name === _this2.state.name;
						});
				...
				if (input === 'email' || input === 'all') {
					var valid = /^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z]+$/;
					if (!this.state.email) {
						error.email = '請輸入電子信箱';
						this.setState({ error: error });
						noError = false;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_data_List2.default, { showEditModal: this.showEditModal }),
					_react2.default.createElement(
						_Modal2.default,
						{ id: 'edit-modal', title: '\u4FEE\u6539\u8CC7\u6599' },
						_react2.default.createElement(
							'form',
							null,
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'button',
									{ className: 'btn btn-cancel', 'data-dismiss': 'modal' },
									'\u53D6\u6D88'
								),
								_react2.default.createElement(
									'button',
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ selectItem: _actions.selectItem, editItem: _actions.editItem }, dispatch);
	}
...
/***/ (function(module, exports) {
	...
	function editItem(item, prevName) {
		return {
			type: EDIT_ITEM,
			payload: item,
			prevName: prevName
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DataList = function (_Component) {
	  ...
	  function DataList(props) {
	    ...
	    _this.showDeleteModal = function (item, e) {
	  ...
	  _createClass(DataList, [{
	    ...
	    value: function listItems() {
	      ...
	      return this.props.data.map(function (item, index) {
	        return _react2.default.createElement(
	          'li',
	          { key: index, className: 'item myRow',
	            onClick: function onClick() {
	              return _this2.props.showEditModal(item);
	            }
	          },
	          _react2.default.createElement(
	            'div',
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'small-col' },
	            _react2.default.createElement('img', { src: './img/delete.png', title: '\u522A\u9664\u6B64\u5217', alt: 'delete',
	              onClick: function onClick(e) {
	                return _this2.showDeleteModal(item, e);
	              }
	            })
	          )
	        );
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('div', { className: 'small-col' })
	        ),
	        this.listItems()
	      );
	    }
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ selectItem: _actions.selectItem }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Modal(props) {
	  var className = "modal-dialog " + props.size;
	  return _react2.default.createElement(
	    "div",
	    { className: "modal fade", id: props.id, tabIndex: "-1", role: "dialog" },
	    _react2.default.createElement(
	      "div",
	      { className: className },
	      _react2.default.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Input(props) {
		...
		var className = 'form-control ' + (error ? 'is-invalid' : '');
		// touched && 
		return _react2.default.createElement(
			'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddModal = function (_Component) {
		...
		function AddModal() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddModal.__proto__ || Object.getPrototypeOf(AddModal)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				name: '',
				phone: '',
				email: '',
				error: { name: '', phone: '', email: '' }
				...
				if (_this.validate()) {
					_this.props.addItem({ name: name, phone: phone, email: email });
					_this.setState({
						name: '',
						phone: '',
						email: '',
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ addItem: _actions.addItem }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DeleteModal = function (_Component) {
		...
		function DeleteModal() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DeleteModal.__proto__ || Object.getPrototypeOf(DeleteModal)).call.apply(_ref, [this].concat(args))), _this), _this.onDeleteClick = function () {
				_this.props.deleteItem(_this.props.item);
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ deleteItem: _actions.deleteItem }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_data = __webpack_require__(69);

	var _reducer_data2 = _interopRequireDefault(_reducer_data);

	var _reducer_selectedItem = __webpack_require__(70);

	var _reducer_selectedItem2 = _interopRequireDefault(_reducer_selectedItem);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  data: _reducer_data2.default,
	  item: _reducer_selectedItem2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var defaultData = [{ name: 'Joe Kim', phone: '0928-387528', email: 'kkbox@yahoo.com.tw' }, { name: 'Kathy McDanold', phone: '0915-031204', email: 'together@gmail.com' }, { name: 'Lily Wang', phone: '0920-832413', email: 'rakuten_team@gmail.com' }, { name: 'Harry Potter', phone: '0920-257396', email: 'rakuten_group@gmail.com' }, { name: 'Eddie Redmayne', phone: '0920-290657', email: 'rakuten_react@gmail.com' }];
