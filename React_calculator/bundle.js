...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculator = __webpack_require__(61);

	var _calculator2 = _interopRequireDefault(_calculator);

	var _result_list = __webpack_require__(64);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-12 col-md-6' },
	          _react2.default.createElement(_result_list2.default, null)
	        )
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Calculator = function (_Component) {
		...
		function Calculator() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Calculator.__proto__ || Object.getPrototypeOf(Calculator)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				...
				secondNumber: '',
				withDecimal: false
			}, _this.changeInput = function (calInput) {
				if (calInput === '.') {
					if (_this.state.withDecimal === true) {
						calInput = '';
					} else {
						_this.setState({ withDecimal: true });
					}
				}

				if (_this.state.input === '0') {
					...
					if (calInput === '.' && _this.state.secondNumber === '') calInput = '0.';
			...
			}, _this.changeOperator = function (calOperator) {
				_this.setState({
					input: _this.state.firstNumber + calOperator,
					operator: calOperator,
					secondNumber: '',
					withDecimal: false
				});
			}, _this.submitInput = function () {
				var _this$state = _this.state,
				    input = _this$state.input,
				    operator = _this$state.operator,
				    firstNumber = _this$state.firstNumber,
				    secondNumber = _this$state.secondNumber;
				...
				_this.setState({ input: '0', firstNumber: '0', operator: '', secondNumber: '', withDecimal: false });
				_this.props.addResult(result, answer);
		...
		_createClass(Calculator, [{
			...
			value: function renderList() {
				...
				return this.props.buttons.map(function (button, index) {
					switch (button) {
						case '=':
							return _react2.default.createElement(_button2.default, { key: index, content: button, className: 'isEqual',
								click: function click() {
									return _this2.submitInput(button);
								} });
							break;
						case '+':
						case '-':
						case '×':
						case '÷':
							return _react2.default.createElement(_button2.default, { key: index, content: button, className: 'isOperator',
								click: function click() {
									return _this2.changeOperator(button);
								} });
							break;
						default:
							return _react2.default.createElement(_button2.default, { key: index, content: button,
								click: function click() {
									return _this2.changeInput(button);
								} });
					}
				});
			}
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ addResult: _index.addResult }, dispatch);
	}
...
/***/ (function(module, exports) {
	...
	exports.sortAscResult = sortAscResult;
	exports.sortDescResult = sortDescResult;
	function addResult(result, answer) {
		return {
			type: 'ADD_RESULT',
			payload: result,
			answer: answer
	...
	function sortAscResult() {
		return {
			type: 'SORT_ASC_RESULT'
		};
	}

	function sortDescResult() {
		return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var button = function button(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: className, onClick: props.click },
	    props.content
	  );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ResultList = function (_Component) {
		...
		function ResultList() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ResultList.__proto__ || Object.getPrototypeOf(ResultList)).call.apply(_ref, [this].concat(args))), _this), _this.deleteResult = function (id) {
				_this.props.deleteResult(id);
			}, _this.sortAscResult = function () {
				_this.props.sortAscResult();
			}, _this.sortDescResult = function () {
				_this.props.sortDescResult();
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
						...
						_react2.default.createElement(
							...
							{ className: 'delete',
								onClick: function onClick() {
									return _this2.deleteResult(item.id);
								} },
							'X'
						)
					);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						'\u8A08\u7B97\u7D50\u679C\u5217\u8868',
						_react2.default.createElement('span', { className: 'triangle upTriangle', onClick: this.sortAscResult }),
						_react2.default.createElement('span', { className: 'triangle downTriangle', onClick: this.sortDescResult })
					),
					this.renderList()
				);
			}
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({
			deleteResult: _index.deleteResult,
			sortAscResult: _index.sortAscResult,
			sortDescResult: _index.sortDescResult
		}, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ResultList);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_buttons = __webpack_require__(66);

	var _reducer_buttons2 = _interopRequireDefault(_reducer_buttons);

	var _reducer_results = __webpack_require__(67);
	...
	var rootReducer = (0, _redux.combineReducers)({
	  // state: (state = {}) => state
	  buttons: _reducer_buttons2.default,
	...
	exports.default = function () {
		...
		switch (action.type) {
			...
			case 'SORT_ASC_RESULT':
				var ascState = [].concat(_toConsumableArray(state));
				return ascState.sort(function (a, b) {
					return a.answer - b.answer;
				});
			case 'SORT_DESC_RESULT':
				var descState = [].concat(_toConsumableArray(state));
				return descState.sort(function (a, b) {
